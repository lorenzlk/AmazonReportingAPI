/**
 * Google Sheets Writer - usmagazine05-20
 * 
 * This step receives results from the usmagazine05-20 scraper
 * and saves them to Google Sheets tab "mula0f-20"
 * 
 * SETUP:
 * 1. Connect Google Sheets app in props
 * 2. Set GOOGLE_SHEET_ID environment variable
 * 3. Reference the scraper step: steps["Scraper - usmagazine05-20"]
 */
