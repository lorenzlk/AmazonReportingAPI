/**
 * Google Sheets Writer - bm01f-20
 * 
 * This step receives results from the bm01f-20 scraper
 * and saves them to Google Sheets tab "mula07-20"
 * 
 * SETUP:
 * 1. Connect Google Sheets app in props
 * 2. Set GOOGLE_SHEET_ID environment variable
 * 3. Reference the scraper step: steps["Scraper - bm01f-20"]
 */
...
export default defineComponent({
  ...
  async run({ steps, $ }) {
    console.log('📊 Adding bm01f-20 data to Google Sheets...');
